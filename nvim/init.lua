...
vim.keymap.set('n', '<leader>sh', require('telescope.builtin').find_files, { desc = '[S]earch [F]iles' })
vim.keymap.set('n', '<leader>st', require('telescope.builtin').help_tags, { desc = '[S]earch [H]elp' })
...
local neotreeConfig = require("custom.setup.setupfiletree")
neotreeConfig.setup()
...
-- a dedicated handler.
-- function (prettier) -- default handler (optional)
